...
const arrayChecker = param => Array.isArray(param) ? true : false
...
const numFromString = string => parseInt(string, 10)
...
const makeItAString = param => param.toString()
